      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            Nuestros <span className="text-novativa-teal">Servicios</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Soluciones impulsadas por inteligencia artificial para automatizar y acelerar tu negocio.
          </p>
        </div>
      </div>
    </section>
    ...
    <section className="py-16 bg-white" id="agente-ia-web">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            <h2 className="text-3xl font-bold mb-6 text-novativa-teal">Agente IA Web</h2>
            <p className="text-lg text-gray-600 mb-8">
              Integra asistentes virtuales inteligentes en tu sitio web para captar leads, ofrecer soporte en tiempo real y automatizar la interacción con tus clientes.
            </p>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="font-bold">Chatbot para captación de leads</h3>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="font-bold">Agente IA Widget en Web</h3>
                  <p className="text-gray-600">
                    Widget informativo o de soporte que responde preguntas sobre tu negocio las 24/7.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="font-bold">Videobot</h3>
                  <p className="text-gray-600">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  <h3 className="font-bold">Página Informativa + Agente IA</h3>
                  <p className="text-gray-600">
