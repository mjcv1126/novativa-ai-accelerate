...
import { ChevronDown, ChevronUp, Phone, Mail, MapPin, MessageCircle, Calendar, Scale, Shield, FileText, Users, Home, Truck, CheckCircle, Gavel, Menu, X, Facebook, Instagram, Play } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/80 backdrop-blur-sm" onClick={() => setTiktokOpen(false)}>
          <div className="relative w-[90vw] max-w-[400px]" onClick={(e) => e.stopPropagation()}>
            <button
              ...
              className="absolute -right-2 top-10 bg-amber-700 hover:bg-amber-600 text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg shadow-black/40 transition-colors z-10 flex items-center gap-1.5"
            >
              Cerrar <X size={14} />
            </button>
