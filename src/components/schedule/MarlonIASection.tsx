...
const MarlonIASection = () => {
  ...
  return (
    <div className="bg-card/80 backdrop-blur-lg rounded-xl shadow-lg p-8 mb-12 border border-border">
      ...
      <a 
        href="https://youtube.com/@novativa-ia?si=yOSOoIuZSwFzhMv0"
        target="_blank"
        rel="noopener noreferrer"
        className="mb-8 w-full flex items-center justify-between gap-4 px-6 py-4 bg-gradient-to-r from-red-600 to-red-700 rounded-xl hover:from-red-700 hover:to-red-800 transition-all shadow-lg group"
      >
        <div className="flex items-center gap-4">
          ...
          <div className="text-white">
            <p className="font-semibold text-lg">Novativa IA</p>
            <p className="text-white/80 text-sm">Suscríbete a nuestro canal de YouTube</p>
          </div>
        </div>
        <span className="px-5 py-2 bg-white text-red-600 rounded-full font-semibold text-sm group-hover:bg-gray-100 transition-colors whitespace-nowrap">
          Suscribirse
        </span>
      </a>
