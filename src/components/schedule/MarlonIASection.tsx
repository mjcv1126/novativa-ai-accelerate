  ...
  return (
    <div className="bg-card/80 backdrop-blur-lg rounded-xl shadow-lg p-8 mb-12 border border-border">
      ...
      <div className="flex flex-col items-center mb-8">
        <h3 className="text-lg font-medium mb-4 text-foreground">Suscríbete a nuestro canal de YouTube</h3>
        <div className="w-full max-w-[560px] aspect-video rounded-lg overflow-hidden border border-border/20">
          <iframe 
            width="100%" 
            height="100%" 
            src="https://www.youtube.com/embed?listType=user_uploads&list=novativa-ia" 
            title="Novativa IA YouTube Channel"
            frameBorder="0" 
