...
const MarlonIASection = () => {
  useEffect(() => {
    ...
    return () => {
      ...
      // Elimina el embed flotante cuando el componente se desmonta
  ...
  return (
    <div className="bg-white bg-opacity-80 backdrop-blur-lg rounded-xl shadow-lg p-8 mb-12 border border-blue-100">
      ...
      {/* El nuevo embed aparecerá como burbuja flotante, ya no dentro de este div */}
