            ...
            {isMobile ? (
              <>
                <Button 
                  ...
                  size="sm"
                  className="bg-white text-novativa-teal hover:bg-gray-100 font-bold shadow-lg transition-all hover:scale-105 text-xs px-2 py-1"
                >
                  50% Desc.
                </Button>
          ...
          <div className="flex items-center gap-2">
            ...
            {!isMobile && (
              <Button 
                onClick={handleCTAClick} 
                size="lg"
                className="bg-white text-novativa-teal hover:bg-gray-100 font-bold shadow-lg transition-all hover:scale-105 text-sm px-6 py-3"
              >
