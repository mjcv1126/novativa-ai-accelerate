  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-gradient-to-r from-novativa-darkTeal to-novativa-teal py-4 shadow-lg z-50 px-4">
      <div className="container mx-auto flex flex-col sm:flex-row justify-between items-center gap-4">
        <div>
          <h3 className="text-white text-lg font-semibold">¿Listo para empezar tu proyecto con IA?</h3>
          <p className="text-white/80 text-sm hidden md:block">Agenda una videollamada y cuéntanos sobre tu idea</p>
        </div>
        <Button
          onClick={handleScheduleClick}
          size="lg" 
          className="bg-novativa-orange hover:bg-novativa-orange/90 text-white px-6 w-full sm:w-auto"
        >
