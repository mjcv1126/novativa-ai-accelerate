...
import { Calendar, Clock, User, RefreshCw, ExternalLink } from 'lucide-react';
      ...
      <CardContent>
        <div className="space-y-4">
          <div className="text-sm text-gray-600">
            <p>Próximas citas programadas en TidyCal que se sincronizarán automáticamente con el CRM.</p>
          </div>
