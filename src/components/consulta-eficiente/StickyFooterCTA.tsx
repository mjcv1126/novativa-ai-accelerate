        ...
        <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-2">
              ...
              <div className="flex flex-col">
                ...
                <div className="text-xs sm:text-sm opacity-90 leading-tight">
                  Programa Early Adopters para Médicos
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <Button
              ...
              size="sm"
              className="bg-white text-novativa-teal hover:bg-gray-100 font-bold text-xs sm:text-sm px-3 sm:px-6 py-2 sm:py-3 shadow-lg transition-all hover:scale-105"
            >
              Obtener Descuento
            </Button>
