...
export const blogPosts: BlogPost[] = [
  ...
  },
  {
    ...
    excerpt: "Este artículo explora cómo la IA está transformando el retail, desde la optimización de la gestión de inventario hasta la mejora de la experiencia del cliente en tiendas físicas y online. Aprenderás cómo implementar soluciones de IA para aumentar las ventas y reducir los costos operativos en tu tienda online.",
    author: "Marlon Caballero",
    date: "16/04/2025",
    category: "Retail",
    status: "Publicado",
